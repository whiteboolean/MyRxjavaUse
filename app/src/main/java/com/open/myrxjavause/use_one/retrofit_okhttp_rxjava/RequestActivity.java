package com.open.myrxjavause.use_one.retrofit_okhttp_rxjava;
...
import com.open.myrxjavause.use_one.retrofit_okhttp_rxjava.retrofit_okhttp.IRequestNetwork;
import com.open.myrxjavause.use_one.retrofit_okhttp_rxjava.retrofit_okhttp.LoginRequest;
import com.open.myrxjavause.use_one.retrofit_okhttp_rxjava.retrofit_okhttp.LoginResponse;
import com.open.myrxjavause.use_one.retrofit_okhttp_rxjava.retrofit_okhttp.MyRetrofit;
import com.open.myrxjavause.use_one.retrofit_okhttp_rxjava.retrofit_okhttp.RegisterRequest;
import com.open.myrxjavause.use_one.retrofit_okhttp_rxjava.retrofit_okhttp.RegisterResponse;
import com.open.myrxjavause.use_one.downloading.DownloadActivity;
        ...
        MyRetrofit.createRetrofit().create(IRequestNetwork.class)
                ...
                .flatMap(new Function<RegisterResponse, ObservableSource<LoginResponse>>() { // todo 4
                    ...
                    public ObservableSource<LoginResponse> apply(RegisterResponse registerResponse) throws Exception {
                        Observable<LoginResponse> loginResponseObservable = MyRetrofit.createRetrofit().create(IRequestNetwork.class)
                                .loginAction(new LoginRequest());
