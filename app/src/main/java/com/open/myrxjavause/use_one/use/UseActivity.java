package com.open.myrxjavause.use_one.use;
...
import com.open.myrxjavause.use_one.use.api.WanAndroidApi;
import com.open.myrxjavause.use_one.use.bean.ProjectBean;
import com.open.myrxjavause.use_one.use.bean.ProjectItem;
import com.open.myrxjavause.use_one.use.util.HttpUtil;
                ...
                .subscribe(new Consumer<Object>() {
                    ...
                    public void accept(Object o) throws Exception {
                        api.getProject() // 查询主数据
                                ...
                                .as(AutoDispose.autoDisposable(AndroidLifecycleScopeProvider.from(UseActivity.this)))
                                .subscribe(new Consumer<ProjectBean>() {
                                    @Override
                                    public void accept(ProjectBean projectBean) throws Exception {
